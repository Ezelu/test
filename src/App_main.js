...
function App() {
  ...
  const dropDownItems = [
    ...
    { title: 'option-4', value: "option-4", color: 'green', font: 'text-md-black' },
  ...
  return (
    <div style={{
      ...
      <br />
      <Switch checked={checked} switchAction={() => {
        // logic
        // toggle modal
        // setChecked(!checked)
        }} />
        ...
        <form method='GET' action='#' style={{display: 'flex', flexDirection: 'column'}}>
        ...
        <br />
        <form method='GET' action='#' style={{display: 'flex', flexDirection: 'column', width: '500px'}}>
          <input name="first" type='text' placeholder='Enter second' autoComplete='off'/>
          <input name="name" type='text' placeholder='Enter name' autoComplete='off'/>
          <input name="second" type='email' placeholder='Enter email' autoComplete='dfghjkl'/>
          <button type="submit"> Submit Form </button>
        </form>
      ...
      <div style={{ marginLeft: '10rem'}}>
        <Tooltip title="Greetings!" position="bottom" width="300px" sx={{
          color: 'red',
          fontSize: '7px'
        }}>
      ...
      <button className='mt-5 mb-5' onClick={() => setOpenAlert(!openAlert)}> open alert </button>
      ...
      <Alert 
        ...
        content={{
          ...
          message: 'Est elementum id senectus aliquet fermentum enim, scelerisque. Sit platea justo ipsum tortor et porttitor turpis.'
        }}
      />
      ...
      <br />
        ...
        <div style={{
          ...
          {
            statsData.map(data => {
              const {title, content, change, type, id, sec_text, icon, width} = data;
              return (
                <Stats 
                  title={title}
                  content={content}
    ...
    <br />
    <NeutralButton sx={{ margin: '2rem' }} buttonAction={() => console.log('clicked')}> NeutralButton </NeutralButton>
...
// //   NeutralButton,
// //   CheckBox
// // } from '@ezelu/react-component-library-test';
...
//   return (
//     <div style={{
//       background: appTheme === 'dark' ? 'darkblue' : 'white'
//     }}>
//       <button
//         onClick={() => {
//           const theme = localStorage.getItem('theme');
...
//       <p className='mb-7 text-lg-bold'> Hello </p>
...
//         <br />
//       <Typography variant='header-lg'> Hello world </Typography>
...
//       {/* <PinInput items={4} setValue={setPinInputVal} /> */}
